      ...
      >
        ...
        <div className="mb-4 p-4 bg-blue-50 rounded-lg">
          ...
          <p className="text-sm text-blue-700 mb-2">
            <strong>Omvänd skattskyldighet:</strong> Du betalar momsen i Sverige istället för i leverantörens land.
          </p>
          <p className="text-sm text-blue-700 mb-2">
            <strong>Momshantering:</strong> 25% utgående moms + 25% ingående moms (kvittar varandra)
          </p>
          <p className="text-sm text-blue-700">
            <strong>Bokföring:</strong> IT-tjänster (6540) + EU-inköp (4535) med justeringspost (4598)
          </p>
        </div>
      </Layout>
    );
