...
export function useBokfor() {
  ...
  return {
    ...
    setKontonummer,
    setKontobeskrivning,
    setBelopp: formValidation.handleBeloppChange,
    setKommentar,
    setFil: ocr.setFile,
    setPdfUrl: ocr.setPdfUrlValue,
    setTransaktionsdatum: formValidation.handleTransaktionsdatumChange,
    setValtFörval,
    setExtrafält,
    setLeverantör,
    setFakturanummer,
    setFakturadatum: formValidation.handleFakturadatumChange,
