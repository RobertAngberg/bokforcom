  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h1 className="text-2xl font-bold mb-4">AGI XML Generator</h1>
        ...
        {validationErrors.length > 0 && (
          <div className="bg-red-50 border border-red-200 rounded-md p-4 mb-6">
            <h3 className="text-red-800 font-medium mb-2">Valideringsfel:</h3>
        ...
        <div className="space-y-6">
          ...
          <AnimeradFlik title="Avsändare" icon="👤" forcedOpen={true}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Programnamn</label>
                <input
                  type="text"
                  value={formData.programnamn}
                  onChange={(e) =>
                    setFormData((prev) => ({ ...prev, programnamn: e.target.value }))
                  }
            ...
            <div className="space-y-4">
              ...
              {formData.individuppgifter.map((iu, index) => (
                <div key={index} className="border border-gray-200 rounded-md p-4">
                  <h4 className="font-medium mb-3">Individuppgift {index + 1}</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
          ...
          >
            <div className="space-y-4">
              ...
              {formData.franvarouppgifter.map((fu, index) => (
                <div key={index} className="border border-gray-200 rounded-md p-4">
                  <h4 className="font-medium mb-3">Frånvarouppgift {index + 1}</h4>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Frånvarodatum
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="TILLFALLIG_FORALDRAPENNING">
          ...
          {generatedXML && (
            <AnimeradFlik title="Genererad XML" icon="📄" forcedOpen={true}>
              <div className="bg-gray-50 p-4 rounded-md">
                <pre className="whitespace-pre-wrap text-sm overflow-x-auto">{generatedXML}</pre>
              </div>
