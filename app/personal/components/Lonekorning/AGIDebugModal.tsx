...
export default function AGIDebugModal({
  ...
  if (!agiDebugData) return null;

  return (
    <Modal
      isOpen={visaDebug}
      onClose={() => setVisaDebug(false)}
      title="🔍 AGI Debug Information"
      maxWidth="4xl"
    >
        ...
        <div className="bg-slate-700 rounded-lg p-4">
          ...
          <div className="bg-slate-600 rounded p-3">
            <div className="text-white text-sm space-y-1">
              ...
              <div>
                <strong>Telefon:</strong> {agiDebugData.företagsdata?.telefonnummer || "❌ SAKNAS"}
              </div>
              <div>
          ...
          {agiDebugData.anställdaData.map((anst: any, idx: number) => (
            <div key={idx} className="bg-slate-600 rounded p-3 mb-3">
              <div className="text-white text-sm space-y-1">
                ...
                <div>
                  <strong>Tjänsteställe adress:</strong> {anst.tjänsteställe_adress || "❌ SAKNAS"}
                </div>
                <div>
        ...
        <div className="bg-slate-700 rounded-lg p-4">
          ...
          <div className="bg-slate-600 rounded p-3">
            <div className="text-white text-sm space-y-1">
              ...
              <div>
                <strong>Redovisningsperiod:</strong> {agiDebugData.finalAgiData.redovisningsperiod}
              </div>
              <div>
