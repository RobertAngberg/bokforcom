    ...
    beräknaTotalt: (grundlön, modalFields) => {
      const antal =
        typeof modalFields === "number"
          ? modalFields
          : modalFields
            ? parseFloat(modalFields.kolumn2 || "1")
            : 1;
      return beräknaKarensavdrag(grundlön) * antal;
    },
    negativtBelopp: true,
    fält: {
      antalLabel: "Antal",
      ...
      const antal =
        typeof modalFields === "number"
          ...
          : modalFields
            ? parseFloat(modalFields.kolumn2 || "1")
            : 1;
      return beräknaObetaldDag(grundlön) * antal;
    },
    negativtBelopp: true,
    fält: {
      ...
      const antal =
        typeof modalFields === "number"
          ...
          : modalFields
            ? parseFloat(modalFields.kolumn2 || "1")
            : 1;
      return beräknaDaglön(grundlön) * 0.2 * antal;
    },
    negativtBelopp: true,
    fält: {
      antalLabel: "Antal dagar",
    ...
    beräknaTotalt: (grundlön, modalFields) => {
      const antal =
        typeof modalFields === "number"
          ? modalFields
          : modalFields
            ? parseFloat(modalFields.kolumn2 || "0")
            : 0;
      return 2.5 * antal;
    },
    fält: {
      ...
      const antal =
        typeof modalFields === "number"
          ...
          : modalFields
            ? parseFloat(modalFields.kolumn2 || "1")
            : 1;
      return beräknaSemesterLön(grundlön, antal);
    },
